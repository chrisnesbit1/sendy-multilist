...
class WPSM_Widget extends WP_Widget {
    ...
    public function __construct() {
      ...
      parent::__construct( 'Sendy_Multilist', 'Sendy Multilist', $widget_ops );
      ...
      $query = new WP_Query(array(
	    ...
	    if (!$list_id) {
			...
			//EMAIL MESSAGE
			$list_data['email_message'] = nl2br($list_data['email_message']);
    ...
    public function widget( $args, $instance ) {
    		//if ($_SERVER['REMOTE_ADDR'] != '174.107.164.98') { return; }
